...
public class PropertyPortfolioPage extends CustomerDashboardPage {
	...
	By invalidMPANNumberSign = By.id("checksum-fail");
	By verifiedMPANNumberSign = By.id("checksum-pass");
	...
	public void validateAddMeterDropdown() throws Throwable
	{
		...
		s.assertTrue(hhElectricPresenceStatus, "HH Electric is not displaying in 'Add Meter' dropdown");
		...
		s.assertTrue(nHHElectricPresenceStatus, "nHH Electric is not displaying in 'Add Meter' dropdown");
		...
		s.assertTrue(gasPresenceStatus, "Gas utility is not displaying in 'Add Meter' dropdown");
		...
		s.assertTrue(waterPresenceStatus, "Water utility is not displaying in 'Add Meter' dropdown");
